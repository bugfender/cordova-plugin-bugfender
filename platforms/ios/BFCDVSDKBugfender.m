...
- (void)pluginInitialize
{
    ...
    NSString *captureBodies = [[NSBundle mainBundle] objectForInfoDictionaryKey:@"BUGFENDER_NETWORK_LOGGING_CAPTURE_BODIES"];
    if (BFPreferenceEnabled(captureBodies)) {
        [Bugfender setNetworkLoggingCaptureBodies:YES];
    }

    NSString *captureErrorBodies = [[NSBundle mainBundle] objectForInfoDictionaryKey:@"BUGFENDER_NETWORK_LOGGING_CAPTURE_ERROR_RESPONSE_BODIES"];
